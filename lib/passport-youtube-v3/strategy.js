...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  var self = this;
  var url = self._profileURL;
  self._oauth2.getProtectedResource(url, accessToken, function (err, body, res) {
    ...
    try {
      ...
      self._oauth2.get('https://www.googleapis.com/plus/v1/people/me', accessToken, function (err, body, res) {
        if (err) { return done(new InternalOAuthError('failed to fetch user profile', err)); }
